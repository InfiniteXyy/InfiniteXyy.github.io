    ...
    projects: [
      {
        ...
        icon: <div className="i-[fa-solid-skull-crossbones]" />,
        stack: ['React', 'Rust'],
      },
      {
        name: 'Gtd',
        ...
        icon: <div className="i-[fa-solid-check-circle]" />,
        stack: ['React'],
      },
      {
        name: 'Fallacy List',
    ...
    projects: [
      {
        ...
        icon: <div className="i-[fa-solid-calculator]" />,
      },
      {
        ...
        icon: <div className="i-[fa-solid-palette]" />,
      },
      {
    ...
    projects: [
      {
        ...
        url: '',
        badge: 'TBD',
        icon: <div className="i-[fa-solid-icons]" />,
      },
      {
        ...
        icon: <div className="i-[fa-solid-project-diagram]" />,
      },
      {
        ...
        icon: <div className="i-[fa-solid-gavel]" />,
      },
    ],
  },
  {
    ...
    projects: [
      ...
      },
      {
        ...
        icon: <div className="i-[fa-solid-mobile-alt]" />,
      },
      {
        ...
        icon: <div className="i-[fa-solid-bolt]" />,
      },
      {
        ...
        icon: <div className="i-[fa-solid-atom]" />,
      },
      {
        ...
        icon: <div className="i-[fa-solid-rocket]" />,
      },
    ],
  },
];
